...
export default function AuthLayout () {
  ...
  return (
    <div className='min-h-screen flex bg-white'>
      ...
      <div className='hidden lg:flex lg:w-[45%] xl:w-[40%] relative bg-gradient-to-br from-stone-900 via-stone-800 to-stone-900 overflow-hidden'>
        {/* Digital grid */}
        ...
        <div className='absolute bottom-0 left-0 right-0 h-1/2 bg-gradient-to-t from-amber-500/20 to-transparent animated-gradient' />

        {/* Decorative circles */}
        <div className='absolute -top-20 -right-20 w-80 h-80 border border-white/5 rounded-full' />
        <div className='absolute top-40 -left-16 w-64 h-64 border border-amber-500/10 rounded-full' />
        <div className='absolute bottom-20 right-10 w-40 h-40 bg-amber-500/5 rounded-full float-particle' />
        ...
        <div className='relative z-10 flex flex-col justify-center px-12 xl:px-16 py-12 w-full'>
          ...
          <div className='flex items-center gap-3 mb-12'>
            ...
            <div>
              ...
              <p className='text-xs text-stone-400 -mt-0.5'>Bus Tracking System</p>
            </div>
          </div>
          ...
          <h1 className='text-3xl xl:text-4xl font-bold text-white leading-tight mb-4 glitch-text' data-text='Track your bus in real-time'>
            Track your bus
            <br />
            in <span className='text-amber-400'>real-time</span>
          </h1>
          <p className='text-stone-400 text-sm leading-relaxed max-w-sm mb-10'>
          ...
          <div className='space-y-3'>
            {[
              ...
              <div key={i} className='flex items-center gap-3 text-sm text-stone-300 animate-fade-in-up' style={{ animationDelay: `${i * 150}ms` }}>
      ...
      <div className='flex-1 flex flex-col min-h-screen relative bg-stone-50'>
        ...
        <div className='lg:hidden flex justify-center pt-10 pb-4'>
          <div className={`flex items-center gap-3 transition-all duration-700 ${
            ...
            <span className='text-xl font-bold text-stone-800 tracking-tight'>Safara</span>
          </div>
        </div>
